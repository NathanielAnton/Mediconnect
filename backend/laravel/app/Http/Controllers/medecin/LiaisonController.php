...
{
    /**
     * Récupérer les demandes de liaison des secrétaires
     */
    public function getSecretaireRequests(Request $request)
    {
    ...
    /**
     * Accepter une demande de liaison d'un secrétaire
     */
    public function acceptSecretaire(Request $request, $id)
    {
        $medecin = $request->user();
    ...
    /**
     * Refuser une demande de liaison d'un secrétaire
     */
    public function refuseSecretaire(Request $request, $id)
    {
        $medecin = $request->user();
    ...
    /**
     * Récupérer tous les secrétaires liés
     */
    public function getMySecretaires(Request $request)
    {
        $medecin = $request->user();
    ...
    /**
     * Supprimer une liaison avec secrétaire
     */
    public function deleteSecretaire(Request $request, $id)
    {
        $medecin = $request->user();
    ...
    /**
     * Récupérer toutes les liaisons avec secrétaires
     */
    public function getAllSecretaires(Request $request)
    {
        $medecin = $request->user();
    ...
    // ============================================
    // GESTION DES LIAISONS AVEC GESTIONNAIRES
    // ============================================

    /**
     * Récupérer les demandes de liaison des gestionnaires
     */
    public function getGestionnaireRequests(Request $request)
    {
        $medecin = $request->user();
     ...
     */
    public function acceptGestionnaire(Request $request, $id)
    {
        $medecin = $request->user();
     ...
     */
    public function refuseGestionnaire(Request $request, $id)
    {
        $medecin = $request->user();
     ...
     */
    public function getMyGestionnaires(Request $request)
    {
        $medecin = $request->user();
    ...
    /**
     * Supprimer une liaison avec gestionnaire
     */
    ...
    /**
     * Récupérer toutes les liaisons avec gestionnaires
     */
    public function getAllGestionnaires(Request $request)
    {
        $medecin = $request->user();
