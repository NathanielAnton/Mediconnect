...
import "./GestionnaireLiaisons.css";

function GestionnaireLiaisons() {
  ...
  const fetchLiaisons = async () => {
    try {
      const response = await axiosInstance.get("/gestionnaire/liaisons");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post("/gestionnaire/liaisons", {
        email,
        message,
      });
  ...
  const handleCancel = async (id) => {
    ...
    try {
      await axiosInstance.delete(`/gestionnaire/liaisons/${id}`);
  ...
  return (
    <div className="gestionnaire-liaisons">
...
export default GestionnaireLiaisons;
